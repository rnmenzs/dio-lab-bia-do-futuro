...
> Quem começa a investir enfrenta um paradoxo: nunca houve tantas opções —
> Tesouro, CDB, fundos — e nunca foi tão difícil escolher. O resultado?
> Dinheiro parado na conta, ou investido por palpite. É o caso do João:
> 32 anos, R$ 10 mil guardados dos R$ 15 mil da reserva de emergência...
> e travado, com medo de errar.

### 2. A Solução (~55 seg)

> O InvestIA é um consultor virtual de investimentos com três comportamentos.
> Ele **antecipa**: logo na primeira resposta, já aponta a meta mais urgente
> do cliente. Ele **personaliza**: só sugere produtos do catálogo compatíveis
> com o perfil, explicando o porquê em português claro. E ele **pergunta na
> dúvida**: o perfil do João se contradiz sobre risco — em vez de decidir
> sozinho, o agente aponta o conflito e pergunta o que vale.
>
> E o coração do projeto: no setor financeiro, IA que inventa informação é
> inaceitável. Por isso, anti-alucinação em duas camadas: onze regras no
> prompt e uma validação por código. Se o modelo citar produtos conhecidos
> fora do catálogo — poupança, cripto, COE — ou recomendar algo incompatível
> com o perfil, a resposta é descartada antes de chegar ao cliente.
